...
#define MAX_TEXTURES 3                                  // This says how many textures we will be using
...
// This loads a texture into OpenGL from a file
void CreateTexture(UINT textureArray[] , char *filename , int textureID );
