...
void MainLoop(void)
{
    ...
    while(! done)                                          // as long as our job's not done
    {
        ...
        if( bUpdate )
        {
            ...
            sprintf(strTitle,"Current Texture Renders Per Second: %d Current Texture Size: %d",g_BlurRate,g_Viewport);
            SDL_WM_SetCaption(strTitle,"Game Tutorials");
        }
...
/////// * /////////// * /////////// * NEW * /////// * /////////// * /////////// *
        ...
        case SDLK_LEFT :                     // If we hit the LEFT arrow key
             ...
             if( g_BlurRate < 10 ) g_BlurRate = 10; 
                                             // Make sure we don't go below 10
        ...
        case SDLK_SPACE :                    // Turn on/off rotation
             g_bRotate = !g_bRotate;
             break;
