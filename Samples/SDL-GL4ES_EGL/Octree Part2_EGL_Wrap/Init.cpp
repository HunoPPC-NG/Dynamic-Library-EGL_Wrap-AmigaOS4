...
bool isExtensionSupported(string ext)
{
    ...
    while( !supported )
    {
        if ( !extensions.compare(pos,n,ext) >= 0 )
        {
            return true;
        }
...
int main(void)
{
    ...
    CreateMyWindow("www.GameTutorials.com - Octree With Frustum Culling", SCREEN_WIDTH, SCREEN_HEIGHT, VideoFlags);
...
//// * QUICK NOTES *
////
//// Nothing was added to our initialization to deal with creating an octree.
////
////
