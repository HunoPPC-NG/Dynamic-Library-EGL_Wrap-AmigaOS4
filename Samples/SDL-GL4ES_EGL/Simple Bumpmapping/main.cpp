...
void Init(ESContext *esContext)
{
	...
	normalMapImage.Load("NormalMapOS4.tga");
...
void Keyboard(ESContext *esContext, unsigned char key, int x, int y)
{
    switch (key) {
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow(&esContext, "Simple Bumpmapping EGL Glues OS4");
